 ...
 * @status
 */
public class json implements TalendJob {
	...
	private final String jobName = "json";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(json.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_NETFLIX_json = new byte[0];
		static byte[] commonByteArray_NETFLIX_json = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_NETFLIX_json.length) {
					if (length < 1024 && commonByteArray_NETFLIX_json.length == 0) {
						commonByteArray_NETFLIX_json = new byte[1024];
					} else {
						commonByteArray_NETFLIX_json = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_NETFLIX_json, 0, length);
				strReturn = new String(commonByteArray_NETFLIX_json, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_NETFLIX_json) {
...
///////////////////////    			
				...
				try {
					filenameOrStream_tFileInputJSON_1 = "E:/4 months/data expolaration/talend/json.json";
...
///////////////////////		
						...
						if (row1.value != null) { //
							...
							strBuffer_tLogRow_1.append(String.valueOf(row1.value));
						...
						if (row1.onclick != null) { //
							...
							strBuffer_tLogRow_1.append(String.valueOf(row1.onclick));
...
///////////////////////    			
				...
				try {
					filename_tFileInputXML_1 = "E:/4 months/data expolaration/talend/payment.xml";
				} catch (java.lang.Exception e) {
					...
					for (org.dom4j.Node temp_tFileInputXML_1 : nodeList_tFileInputXML_1) {
						...
						try {
							...
							if (xml_api_tFileInputXML_1.isDefNull(node_tFileInputXML_1)) {
								...
								row2.id = ParserUtils.parseTo_Integer(str_tFileInputXML_1);
							}
...
///////////////////////		
							...
							if (row2.mode != null) { //
								...
								strBuffer_tLogRow_2.append(String.valueOf(row2.mode));
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final json jsonClass = new json();

		int exitCode = jsonClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = json.class.getClassLoader()
					.getResourceAsStream("netflix/json_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = json.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : json");
		}
...
/************************************************************************************************
 * 57919 characters generated by Talend Open Studio for Data Integration on the
 * January 31, 2025 at 6:03:02 PM EET
 ************************************************************************************************/